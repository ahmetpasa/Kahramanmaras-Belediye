...
public class kesfedinikiIntent extends AppCompatActivity {
    String url;
    String ss;
    TextView textView;
    ImageView image;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kesfediniki_intent);
    ...
    class jsoup4 extends AsyncTask<String,String,String> {

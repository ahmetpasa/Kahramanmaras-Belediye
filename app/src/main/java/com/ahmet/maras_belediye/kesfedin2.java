...
public class kesfedin2 extends Fragment {
    ImageView image ;
    String ss="";
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v=inflater.inflate(R.layout.fragmentkesfedin2,container,false);
        image=v.findViewById(R.id.imageView6);
        jsoup2 jsoup=new jsoup2();
        jsoup.execute();
        image.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent ıntent=new Intent(getContext(),kesfedinikiIntent.class);
    ...
    class jsoup2 extends AsyncTask<String,String,String> {
